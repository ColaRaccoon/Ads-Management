...
const [privateKeyPath, contractSha256, taskName, issuedText, expiresText, authorizationNonce, authorizationInstanceId, pgPassSha256, backupIntegrityKeySha256, backupReceiptPrivateKeySha256, receiptPublisherSha256, semanticSignerSha256, nasIdentityHelperSha256, outputPath] = process.argv.slice(2);
const hashes = [contractSha256, pgPassSha256, backupIntegrityKeySha256, backupReceiptPrivateKeySha256, receiptPublisherSha256, semanticSignerSha256, nasIdentityHelperSha256];
...
const value = { attestationType: "backup-schedule-authorization", version: 3, result: "APPROVED", taskName, contractSha256, authorizationNonce, authorizationInstanceId, authorizationIssuedAt: issued.toISOString(), authorizationExpiresAt: expires.toISOString(), pgPassSha256, backupIntegrityKeySha256, backupReceiptPrivateKeySha256, receiptPublisherSha256, semanticSignerSha256, nasIdentityHelperSha256 };
