...
if (!plainObject(value) || "signingKeyId" in value || "attestationSignature" in value ||
    !new Set(["backup-signer-authorization", "backup-schedule-authorization", "restore-verification", "release-compatibility", "legacy-quiesce", "legacy-database-rollback"]).has(value.attestationType)) {
