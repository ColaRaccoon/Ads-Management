...
async function fixture() {
  ...
  const backupId = "20260828T010203Z-aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa";
  ...
  const manifest = {
    version:6,result:"COMPLETE",backupId,createdAt:"2026-08-28T01:02:03.1234567Z",rpoHours:24,rtoHours:4,
