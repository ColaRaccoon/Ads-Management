...
const value=validateLocalRuntimeConfig(raw,{
  ...
  clientTrustEvidence:readJson(raw.tls?.clientTrustEvidencePath),backupTargetEvidence:readJson(raw.backup?.physicalTargetEvidencePath),
  ...
  firewallEvidence:readJson(raw.hostSecurity?.firewallEvidencePath),restoreEvidence:readJson(raw.backup?.restoreEvidencePath),recoveryEvidence:readJson(raw.backup?.recoveryEvidencePath),
