...
if (!publicKeyPath || !evidencePath || !new Set(["backup-latest", "restore-verification", "release-compatibility", "legacy-quiesce", "legacy-database-rollback"]).has(expectedType)) fail();
