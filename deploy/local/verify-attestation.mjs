...
if (!publicKeyPath || !evidencePath || !new Set(["backup-latest", "backup-signer-authorization", "backup-schedule-authorization", "restore-verification", "release-compatibility", "legacy-quiesce", "legacy-database-rollback", "edge-drain"]).has(expectedType)) fail();
