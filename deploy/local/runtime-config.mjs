...
function recoveryContractFingerprint(evidence) { return sha256Tuple("recovery-pair-v2",evidence?.kitId,evidence?.manifestSha256,evidence?.runtimeConfigSha256,evidence?.installId,evidence?.inventoryDigest,evidence?.escrowWorksheetSha256,evidence?.executorSetDigest,evidence?.sourceHostInstanceDigest,evidence?.verificationHostInstanceDigest,evidence?.escrowType,evidence?.escrowIdentitySha256,String(evidence?.escrowAddressCount)); }
