...
function trustedEvidence(now, value, backupRoot) {
  ...
  const backupPins={pgPassSha256:"0".repeat(64),pgRestoreSha256,backupIntegrityKeySha256:"1".repeat(64),backupReceiptPrivateKeySha256:"2".repeat(64),receiptPublisherSha256:"3".repeat(64),semanticSignerSha256:"4".repeat(64),nasIdentityHelperSha256};
