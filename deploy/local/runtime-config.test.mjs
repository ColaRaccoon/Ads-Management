...
test("operational readiness requires both current-host and clean-PC recovery evidence", () => {
  ...
  sameHostEvidence.recoveryContractDigest=sha256Tuple("recovery-pair-v2",sameHostEvidence.kitId,sameHostEvidence.manifestSha256,sameHostEvidence.runtimeConfigSha256,sameHostEvidence.installId,sameHostEvidence.inventoryDigest,sameHostEvidence.escrowWorksheetSha256,sameHostEvidence.executorSetDigest,sameHostEvidence.sourceHostInstanceDigest,sameHostEvidence.verificationHostInstanceDigest,sameHostEvidence.escrowType,sameHostEvidence.escrowIdentitySha256,String(sameHostEvidence.escrowAddressCount));
...
function trustedEvidence(now, value, backupRoot) {
  ...
  const result = {
    now,
    runtimeConfigSha256,
    recoveryEvidence: { version: 6, result: "PASS", proofType: "current-host-recovery", recoveryContractDigest: sha256Tuple("recovery-pair-v2","8".repeat(64),"9".repeat(64),runtimeConfigSha256,"install-test-0001","6".repeat(64),"4".repeat(64),sha256Tuple(nodeSha256,recoveryToolSha256),"a".repeat(64),"a".repeat(64),"REMOTE_NAS","c".repeat(64),"2"), sourceHostInstanceDigest: "a".repeat(64), verificationHostInstanceDigest: "a".repeat(64), escrowType: "REMOTE_NAS", escrowIdentitySha256: "c".repeat(64), escrowAddressCount: 2, escrowLocalAliasRejected: true, kitId: "8".repeat(64), kitSha256: "8".repeat(64), worksheetSha256: "4".repeat(64), localWorksheetSha256: "4".repeat(64), escrowWorksheetSha256: "4".repeat(64), localKitSha256: "8".repeat(64), escrowKitSha256: "8".repeat(64), manifestSha256: "9".repeat(64), installId: "install-test-0001", runtimeConfigSha256, inventoryDigest: "6".repeat(64), databaseCredentialInventoryDigest: databaseEvidence("2026-08-26T11:55:00.000Z").credentialInventoryDigest, backupIntegrityKeySha256: "7".repeat(64), nodeSha256, toolSha256: recoveryToolSha256, executorSetDigest: sha256Tuple(nodeSha256,recoveryToolSha256), exactInventory: true, authenticatedExtract: true, boundedExtract: true, boundedConcurrentChildOutput: true, processTreeKillOnDeadline: true, disasterRecoveryVerified: false, sourcePathsDisclosed: false, extractionRetained: false, currentInstallBound: true, currentSourceHashesVerified: true, localCopyPresent: true, escrowCopyPresent: true, escrowWorksheetPresent: true, escrowSeparated: true, copiesMatch: true, adminOnlyAcl: true, testExtractRemoved: true, pfxPrivateKeyVerified: true, caIdentityVerified: true, completedAt },
  ...
  result.disasterRecoveryEvidence.recoveryContractDigest=sha256Tuple("recovery-pair-v2","8".repeat(64),"9".repeat(64),runtimeConfigSha256,"install-test-0001","6".repeat(64),"4".repeat(64),sha256Tuple(nodeSha256,recoveryToolSha256),"a".repeat(64),"b".repeat(64),"REMOTE_NAS","c".repeat(64),"2");
