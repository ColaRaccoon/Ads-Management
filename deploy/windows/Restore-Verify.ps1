...
"@
  ...
  $targetMutationAfterDigest=Invoke-MutationSmoke ([IO.Path]::GetFullPath($TargetReleaseRoot)) ([string]$targetRelease.releaseId) $TargetApiConfigPath
